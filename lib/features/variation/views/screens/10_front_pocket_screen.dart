        ...
        children: [
          ...
          BlocConsumer<FrontPocketCubit, FrontPocketState>(
            ...
            builder: (context, state) {
              ...
              } else if (state is FrontPocketSuccess || state is FrontPocketSelected) {
                return Column(
                  children: [
                    Space(
                      height: 3.h,
                    ...
                    GridView.builder(
                      ...
                      itemCount:
                          context.read<FrontPocketCubit>().frontPockets.length,
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return VariantCard(
                          ...
                          onTap: () => context.read<FrontPocketCubit>().onFrontPocketCardTap(index,context)
                              // context
                              // .read<FrontPocketCubit>()
