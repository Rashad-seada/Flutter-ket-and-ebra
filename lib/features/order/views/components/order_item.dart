...
import 'package:smart_soft/features/order/views/screens/15_order_item_details_screen.dart';
    ...
    return InkWell(
      ...
      onTap: ()=>
          Navigator.push(context,MaterialPageRoute(
              builder: (_)=> OrderItemDetailsScreen(sellerOrder: orderItemEntity.orderDetails!.toSellerOrder()))),
      child: Container(
